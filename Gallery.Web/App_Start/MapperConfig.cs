...
namespace Gallery.Web
{
    internal class MapperConfig : Module
    {
        ...
        {
            config.CreateMap<Unit, ViewModels.Unit.CreateEditViewModel>().ReverseMap();
            config.CreateMap<Branch, ViewModels.Branch.CreateEditViewModel>().ReverseMap();
            config.CreateMap<EmployeeVisitResponse, ViewModels.EmployeeVisitResponse.CreateEditViewModel>().ReverseMap();
            config.CreateMap<EmployeeVisitCategory, ViewModels.EmployeeVisitCategory.CreateEditViewModel>().ReverseMap();
            config.CreateMap<CustomerVisitCategory, ViewModels.CustomerVisitCategory.CreateEditViewModel>().ReverseMap();
            config.CreateMap<Taxonomy, ViewModels.Taxonomy.CreateEditViewModel>().ReverseMap();
            config.CreateMap<ComplaintType, ViewModels.ComplaintType.CreateEditViewModel>().ReverseMap();
            config.CreateMap<Region, ViewModels.Region.CreateEditViewModel>().ReverseMap();
            config.CreateMap<Fee, ViewModels.Fee.CreateEditViewModel>().ReverseMap();


            config.CreateMap<Role, ViewModels.Role.CreateEditViewModel>().ReverseMap();
