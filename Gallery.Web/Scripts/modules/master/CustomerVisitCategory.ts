...
class CustomerVisitCategoryClientProvider extends ClientProvider {
...
$(() => {
    let visitCategory: CustomerVisitCategoryClientProvider = new CustomerVisitCategoryClientProvider();
