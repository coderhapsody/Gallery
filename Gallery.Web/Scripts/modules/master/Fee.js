...
var FeeClientProvider = (function (_super) {
    __extends(FeeClientProvider, _super);
    function FeeClientProvider() {
    ...
    return FeeClientProvider;
}(ClientProvider));
$(function () {
    var fee = new FeeClientProvider();
